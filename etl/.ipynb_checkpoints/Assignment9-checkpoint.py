   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Destination tables cleared successfully!\n",
      "\n",
      "Starting ETL process...\n",
      "Populating dim_date...\n",
      "Populating dim_category...\n",
      "Populating dim_book...\n",
      "Populating dim_client...\n",
      "Error during ETL process: 1292 (22007): Truncated incorrect DOUBLE value: 'Alice'\n",
      "ETL process failed: 1292 (22007): Truncated incorrect DOUBLE value: 'Alice'\n",
